...
In our current client-side router (`packages/eigen/router.tsx` from Part 11), every navigation replaces the entire component tree. To support layout persistence, the router needs to diff the layout stacks:
